  ...
  >
    {({ isActive }) => (
      <>
        <Icon
          size={18}
          className={`flex-shrink-0 transition-colors duration-200 ${isActive ? "text-[#FF5934]" : "text-[#9CA3AF] group-hover:text-[#111827]"}`}
        />
        {!collapsed && (
...
const NavGroup = ({
  ...
  const hideFlyout = () => {
    hideTimer.current = setTimeout(() => setFlyoutOpen(false), 150);
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Brand Header ── */}
        <div
          className={`flex items-center gap-3 border-b border-gray-50 transition-all duration-300 ${collapsed ? "px-3 py-4 justify-center" : "px-4 py-4"}`}
        >
          ...
          {!collapsed && (
            <div className="overflow-hidden">
              <p className="text-[#111827] font-bold text-[15px] leading-tight tracking-tight">
                Karyana
              </p>
              <p className="text-[10px] font-semibold text-[#B0B7C3] tracking-[0.12em] uppercase">
                Dashboard
              </p>
            </div>
          )}
          ...
          {!isWM && !isCoordinator && (
            <>
              ...
              >
                ...
                />
                <SubNavItem
                  to="/Reports/CustomerLedger"
                  icon={MdReceipt}
                  label="Customer Ledger"
                />
                <SubNavItem
                  to="/Reports/ProductAndInventory"
                  icon={MdReceipt}
...
/>
        ...
        <div className="border-t border-gray-100 p-3">
          ...
          >
            ...
            >
              <span className="text-[#FF5934] font-bold text-xs select-none">
                {initials}
              </span>
            </div>
            ...
            {!collapsed && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#9CA3AF] text-[10px] truncate capitalize">
                  {roleName}
                </p>
              </div>
            )}
