  ...
  return (
    <div className='relative'>
      ...
      <div className='flex justify-between items-center mt-3'>
        <h1 className='text-xl text-nowrap font-bold'>Coordinators</h1>
        <div className='flex gap-7'>
          ...
          <select value={selectedMaritalStatus} onChange={statusSelectHandler} className='bg-[#FFFFFF] rounded-lg p-1'>
          ...
          <button className='bg-[#FFD7CE] text-[#FF5934] font-bold text-nowrap p-2 rounded' onClick={addHandler}>
            + Add Coordinator
          </button>
        </div>
      </div>
      ...
      {show && (
        <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
          <div className='bg-white w-[330px] max-h-[100vh] overflow-auto mt-5 mb-5 rounded-xl shadow-lg'>
            ...
            >
              {() => (
                <Form className='overflow-x-hidden overflow-y-auto p-6 scrollbar-hide'>
                  <h6 className='font-semibold mb-2'>Profile Image</h6>
                  ...
                  <div className='flex justify-between gap-4 border-t border-gray-300 pt-4 mt-6'>
                    <div
                      onClick={() => {
                        setImageLoading(false);
                        setShow(false);
      ...
      <div className={`fixed top-0 right-0 h-full w-[30%] bg-white p-4 shadow-lg transition-transform ${selectedUser ? 'translate-x-0' : 'translate-x-full'}`}>
        {selectedUser && (
          <div className='flex flex-col justify-center items-start relative h-full'>
            ...
            <div style={{ borderBottom: "1px solid rgb(223 223 223)" }} className='mb-2 -bold  w-full '><span className='font-bold'>{selectedUser.name}</span> <br />
              <span className='text-gray-600'>{selectedUser.email}</span></div>
            <div style={{ borderBottom: "1px solid rgb(223 223 223)" }} className='mb-2 w-full'><strong>Phone No:</strong> <br />{selectedUser.phone}</div>
            <div style={{ borderBottom: "1px solid rgb(223 223 223)" }} className='mb-2 w-full'><strong>CNIC:</strong><br /> {selectedUser.cnic}</div>
            <div style={{ borderBottom: "1px solid rgb(223 223 223)" }} className='mb-2 w-full'><strong>City:</strong> <br />{selectedUser.city?.name}</div>
            <div style={{ borderBottom: "1px solid rgb(223 223 223)" }} className='mb-2 w-full'><strong>Address:</strong> <br />{selectedUser.address}</div>
